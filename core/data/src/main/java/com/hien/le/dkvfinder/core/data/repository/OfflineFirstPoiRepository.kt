...
@Singleton
class OfflineFirstPoiRepository @Inject constructor(
     ...
     */
    override suspend fun refreshPois(country: String, maxResults: Int): Boolean {
     ...
     */
    override suspend fun updateFavoriteStatus(poiId: Int, isFavorite: Boolean) {
